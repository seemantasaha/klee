...
@.str.4 = private unnamed_addr constant [8 x i8] c"s==\22hi\22\00", align 1
...
define i32 @main(i32) #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) !dbg !843 {
  ...
  %10 = call i8* @_Znam(i64 24) #8, !dbg !864
  %11 = bitcast i8* %10 to i64*, !dbg !864
  store i64 4, i64* %11, align 8, !dbg !864
  %12 = getelementptr inbounds i8, i8* %10, i64 8, !dbg !864
  %13 = bitcast i8* %12 to %class.Test*, !dbg !864
  %14 = getelementptr inbounds %class.Test, %class.Test* %13, i64 4, !dbg !864
  br label %15, !dbg !864

; <label>:15:                                     ; preds = %15, %1
  %16 = phi %class.Test* [ %13, %1 ], [ %17, %15 ], !dbg !864
  call void @_ZN4TestC2Ev(%class.Test* %16), !dbg !864
  %17 = getelementptr inbounds %class.Test, %class.Test* %16, i64 1, !dbg !864
  %18 = icmp eq %class.Test* %17, %14, !dbg !864
  br i1 %18, label %19, label %15, !dbg !864

; <label>:19:                                     ; preds = %15
  store %class.Test* %13, %class.Test** %4, align 8, !dbg !863
...
; <label>:20:                                     ; preds = %23, %19
  %21 = load i32, i32* %7, align 4, !dbg !870
  %22 = icmp slt i32 %21, 4, !dbg !872
  br i1 %22, label %23, label %32, !dbg !873

; <label>:23:                                     ; preds = %20
  %24 = load %class.Test*, %class.Test** %4, align 8, !dbg !874
  %25 = load i32, i32* %7, align 4, !dbg !875
  %26 = sext i32 %25 to i64, !dbg !874
  %27 = getelementptr inbounds %class.Test, %class.Test* %24, i64 %26, !dbg !874
  %28 = load i32, i32* %7, align 4, !dbg !876
  %29 = add nsw i32 %28, 1, !dbg !877
  call void @_ZN4Test4setXEi(%class.Test* %27, i32 %29), !dbg !878
  %30 = load i32, i32* %7, align 4, !dbg !879
  %31 = add nsw i32 %30, 1, !dbg !879
  store i32 %31, i32* %7, align 4, !dbg !879
  br label %20, !dbg !880, !llvm.loop !881
...
; <label>:33:                                     ; preds = %36, %32
  %34 = load i32, i32* %7, align 4, !dbg !888
  %35 = icmp slt i32 %34, 4, !dbg !890
  br i1 %35, label %36, label %46, !dbg !891

; <label>:36:                                     ; preds = %33
  %37 = load %class.Test*, %class.Test** %4, align 8, !dbg !892
  %38 = load i32, i32* %7, align 4, !dbg !893
  %39 = sext i32 %38 to i64, !dbg !892
  %40 = getelementptr inbounds %class.Test, %class.Test* %37, i64 %39, !dbg !892
  %41 = call i32 @_ZN4Test4getXEv(%class.Test* %40), !dbg !894
  %42 = load i32, i32* %8, align 4, !dbg !895
  %43 = add nsw i32 %42, %41, !dbg !895
  store i32 %43, i32* %8, align 4, !dbg !895
  %44 = load i32, i32* %7, align 4, !dbg !896
  %45 = add nsw i32 %44, 1, !dbg !896
  store i32 %45, i32* %7, align 4, !dbg !896
  br label %33, !dbg !897, !llvm.loop !898

; <label>:46:                                     ; preds = %33
  %47 = load i32, i32* %8, align 4, !dbg !900
  %48 = icmp eq i32 %47, 10, !dbg !900
  br i1 %48, label %50, label %49, !dbg !900

; <label>:49:                                     ; preds = %46
  call void @__assert_fail(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.1, i32 0, i32 0), i32 34, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) #9, !dbg !900
  unreachable, !dbg !900

; <label>:50:                                     ; preds = %46
  %51 = load %class.Test*, %class.Test** %4, align 8, !dbg !901
  %52 = icmp eq %class.Test* %51, null, !dbg !902
  br i1 %52, label %65, label %53, !dbg !902

; <label>:53:                                     ; preds = %50
  %54 = bitcast %class.Test* %51 to i8*, !dbg !902
  %55 = getelementptr inbounds i8, i8* %54, i64 -8, !dbg !902
  %56 = bitcast i8* %55 to i64*, !dbg !902
  %57 = load i64, i64* %56, align 4, !dbg !902
  %58 = getelementptr inbounds %class.Test, %class.Test* %51, i64 %57, !dbg !902
  %59 = icmp eq %class.Test* %51, %58, !dbg !902
  br i1 %59, label %64, label %60, !dbg !902

; <label>:60:                                     ; preds = %60, %53
  %61 = phi %class.Test* [ %58, %53 ], [ %62, %60 ], !dbg !902
  %62 = getelementptr inbounds %class.Test, %class.Test* %61, i64 -1, !dbg !902
  call void @_ZN4TestD2Ev(%class.Test* %62) #10, !dbg !902
  %63 = icmp eq %class.Test* %62, %51, !dbg !902
  br i1 %63, label %64, label %60, !dbg !902

; <label>:64:                                     ; preds = %60, %53
  call void @_ZdaPv(i8* %55) #11, !dbg !902
  br label %65, !dbg !902
...
; <label>:65:                                     ; preds = %64, %50
  ...
  call void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC1Ev(%"class.std::__cxx11::basic_string"* %9) #10, !dbg !909
  %66 = bitcast %"class.std::__cxx11::basic_string"* %9 to i8*, !dbg !910
  invoke void @klee_make_symbolic(i8* %66, i64 32, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i32 0, i32 0))
          to label %67 unwind label %70, !dbg !911

; <label>:67:                                     ; preds = %65
  %68 = call zeroext i1 @_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_(%"class.std::__cxx11::basic_string"* dereferenceable(32) %9, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i32 0, i32 0)), !dbg !912
  br i1 %68, label %78, label %69, !dbg !912

; <label>:69:                                     ; preds = %67
  call void @__assert_fail(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.4, i32 0, i32 0), i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.1, i32 0, i32 0), i32 40, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) #9, !dbg !912
  unreachable, !dbg !912

; <label>:70:                                     ; preds = %65
  %71 = landingpad { i8*, i32 }
          cleanup, !dbg !913
  %72 = extractvalue { i8*, i32 } %71, 0, !dbg !913
  store i8* %72, i8** %5, align 8, !dbg !913
  %73 = extractvalue { i8*, i32 } %71, 1, !dbg !913
  store i32 %73, i32* %6, align 4, !dbg !913
  call void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED1Ev(%"class.std::__cxx11::basic_string"* %9) #10, !dbg !913
...
; <label>:78:                                     ; preds = %67
  ...
  call void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED1Ev(%"class.std::__cxx11::basic_string"* %9) #10, !dbg !913
  %79 = load i32, i32* %2, align 4, !dbg !913
  ret i32 %79, !dbg !913
}
...
define linkonce_odr void @_ZN4TestC2Ev(%class.Test*) unnamed_addr #3 comdat align 2 !dbg !915 {
  %2 = alloca %class.Test*, align 8
  store %class.Test* %0, %class.Test** %2, align 8
  call void @llvm.dbg.declare(metadata %class.Test** %2, metadata !916, metadata !DIExpression()), !dbg !917
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN4TestD2Ev(%class.Test*) unnamed_addr #3 comdat align 2 !dbg !919 {
  %2 = alloca %class.Test*, align 8
  store %class.Test* %0, %class.Test** %2, align 8
  call void @llvm.dbg.declare(metadata %class.Test** %2, metadata !920, metadata !DIExpression()), !dbg !921
  %3 = load %class.Test*, %class.Test** %2, align 8
  %4 = getelementptr inbounds %class.Test, %class.Test* %3, i32 0, i32 0, !dbg !922
  %5 = load i32, i32* %4, align 4, !dbg !922
  %6 = load i32, i32* @_ZL5decon, align 4, !dbg !924
  %7 = add nsw i32 %6, %5, !dbg !924
  store i32 %7, i32* @_ZL5decon, align 4, !dbg !924
  ret void, !dbg !925
}
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr void @_ZN4Test4setXEi(%class.Test*, i32) #3 comdat align 2 !dbg !926 {
  %3 = alloca %class.Test*, align 8
  %4 = alloca i32, align 4
  store %class.Test* %0, %class.Test** %3, align 8
  call void @llvm.dbg.declare(metadata %class.Test** %3, metadata !927, metadata !DIExpression()), !dbg !928
  ...
  %7 = getelementptr inbounds %class.Test, %class.Test* %5, i32 0, i32 0, !dbg !932
  store i32 %6, i32* %7, align 4, !dbg !933
  ret void, !dbg !934
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr i32 @_ZN4Test4getXEv(%class.Test*) #3 comdat align 2 !dbg !935 {
  %2 = alloca %class.Test*, align 8
  store %class.Test* %0, %class.Test** %2, align 8
  call void @llvm.dbg.declare(metadata %class.Test** %2, metadata !936, metadata !DIExpression()), !dbg !937
  %3 = load %class.Test*, %class.Test** %2, align 8
  %4 = getelementptr inbounds %class.Test, %class.Test* %3, i32 0, i32 0, !dbg !938
  %5 = load i32, i32* %4, align 4, !dbg !938
  ret i32 %5, !dbg !939
}
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr zeroext i1 @_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_(%"class.std::__cxx11::basic_string"* dereferenceable(32), i8*) #3 comdat !dbg !940 {
  %3 = alloca %"class.std::__cxx11::basic_string"*, align 8
  %4 = alloca i8*, align 8
  store %"class.std::__cxx11::basic_string"* %0, %"class.std::__cxx11::basic_string"** %3, align 8
  call void @llvm.dbg.declare(metadata %"class.std::__cxx11::basic_string"** %3, metadata !1003, metadata !DIExpression()), !dbg !1004
  store i8* %1, i8** %4, align 8
  call void @llvm.dbg.declare(metadata i8** %4, metadata !1005, metadata !DIExpression()), !dbg !1006
  %5 = load %"class.std::__cxx11::basic_string"*, %"class.std::__cxx11::basic_string"** %3, align 8, !dbg !1007
  %6 = load i8*, i8** %4, align 8, !dbg !1008
  %7 = call i32 @_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE7compareEPKc(%"class.std::__cxx11::basic_string"* %5, i8* %6) #10, !dbg !1009
...
!1 = distinct !DIGlobalVariable(name: "decon", linkageName: "_ZL5decon", scope: !2, file: !3, line: 9, type: !22, isLocal: true, isDefinition: true)
...
!843 = distinct !DISubprogram(name: "main", scope: !3, file: !3, line: 23, type: !459, isLocal: false, isDefinition: true, scopeLine: 23, flags: DIFlagPrototyped, isOptimized: false, unit: !2, variables: !4)
!844 = !DILocalVariable(name: "argc", arg: 1, scope: !843, file: !3, line: 23, type: !22)
!845 = !DILocation(line: 23, column: 14, scope: !843)
!846 = !DILocalVariable(name: "rt", scope: !843, file: !3, line: 24, type: !847)
!847 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !848, size: 64)
!848 = distinct !DICompositeType(tag: DW_TAG_class_type, name: "Test", file: !3, line: 11, size: 32, elements: !849, identifier: "_ZTS4Test")
!849 = !{!850, !851, !855, !858, !859, !862}
!850 = !DIDerivedType(tag: DW_TAG_member, name: "x", scope: !848, file: !3, line: 12, baseType: !22, size: 32)
!851 = !DISubprogram(name: "Test", scope: !848, file: !3, line: 15, type: !852, isLocal: false, isDefinition: false, scopeLine: 15, flags: DIFlagPublic | DIFlagPrototyped, isOptimized: false)
!852 = !DISubroutineType(types: !853)
!853 = !{null, !854}
!854 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !848, size: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!855 = !DISubprogram(name: "Test", scope: !848, file: !3, line: 16, type: !856, isLocal: false, isDefinition: false, scopeLine: 16, flags: DIFlagPublic | DIFlagPrototyped, isOptimized: false)
!856 = !DISubroutineType(types: !857)
!857 = !{null, !854, !22}
!858 = !DISubprogram(name: "~Test", scope: !848, file: !3, line: 17, type: !852, isLocal: false, isDefinition: false, scopeLine: 17, flags: DIFlagPublic | DIFlagPrototyped, isOptimized: false)
!859 = !DISubprogram(name: "getX", linkageName: "_ZN4Test4getXEv", scope: !848, file: !3, line: 19, type: !860, isLocal: false, isDefinition: false, scopeLine: 19, flags: DIFlagPublic | DIFlagPrototyped, isOptimized: false)
!860 = !DISubroutineType(types: !861)
!861 = !{!22, !854}
!862 = !DISubprogram(name: "setX", linkageName: "_ZN4Test4setXEi", scope: !848, file: !3, line: 20, type: !856, isLocal: false, isDefinition: false, scopeLine: 20, flags: DIFlagPublic | DIFlagPrototyped, isOptimized: false)
!863 = !DILocation(line: 24, column: 9, scope: !843)
!864 = !DILocation(line: 24, column: 14, scope: !843)
!865 = !DILocalVariable(name: "i", scope: !843, file: !3, line: 25, type: !22)
!866 = !DILocation(line: 25, column: 7, scope: !843)
!867 = !DILocation(line: 27, column: 9, scope: !868)
!868 = distinct !DILexicalBlock(scope: !843, file: !3, line: 27, column: 3)
!869 = !DILocation(line: 27, column: 8, scope: !868)
!870 = !DILocation(line: 27, column: 13, scope: !871)
!871 = distinct !DILexicalBlock(scope: !868, file: !3, line: 27, column: 3)
!872 = !DILocation(line: 27, column: 14, scope: !871)
!873 = !DILocation(line: 27, column: 3, scope: !868)
!874 = !DILocation(line: 28, column: 5, scope: !871)
!875 = !DILocation(line: 28, column: 8, scope: !871)
!876 = !DILocation(line: 28, column: 16, scope: !871)
!877 = !DILocation(line: 28, column: 17, scope: !871)
!878 = !DILocation(line: 28, column: 11, scope: !871)
!879 = !DILocation(line: 27, column: 19, scope: !871)
!880 = !DILocation(line: 27, column: 3, scope: !871)
!881 = distinct !{!881, !873, !882}
!882 = !DILocation(line: 28, column: 19, scope: !868)
!883 = !DILocalVariable(name: "sum", scope: !843, file: !3, line: 30, type: !22)
!884 = !DILocation(line: 30, column: 7, scope: !843)
!885 = !DILocation(line: 31, column: 9, scope: !886)
!886 = distinct !DILexicalBlock(scope: !843, file: !3, line: 31, column: 3)
!887 = !DILocation(line: 31, column: 8, scope: !886)
!888 = !DILocation(line: 31, column: 13, scope: !889)
!889 = distinct !DILexicalBlock(scope: !886, file: !3, line: 31, column: 3)
!890 = !DILocation(line: 31, column: 14, scope: !889)
!891 = !DILocation(line: 31, column: 3, scope: !886)
!892 = !DILocation(line: 32, column: 12, scope: !889)
!893 = !DILocation(line: 32, column: 15, scope: !889)
!894 = !DILocation(line: 32, column: 18, scope: !889)
!895 = !DILocation(line: 32, column: 9, scope: !889)
!896 = !DILocation(line: 31, column: 19, scope: !889)
!897 = !DILocation(line: 31, column: 3, scope: !889)
!898 = distinct !{!898, !891, !899}
!899 = !DILocation(line: 32, column: 23, scope: !886)
!900 = !DILocation(line: 34, column: 3, scope: !843)
!901 = !DILocation(line: 36, column: 12, scope: !843)
!902 = !DILocation(line: 36, column: 3, scope: !843)
!903 = !DILocalVariable(name: "s", scope: !843, file: !3, line: 38, type: !904)
...
!909 = !DILocation(line: 38, column: 15, scope: !843)
!910 = !DILocation(line: 39, column: 22, scope: !843)
!911 = !DILocation(line: 39, column: 3, scope: !843)
!912 = !DILocation(line: 40, column: 3, scope: !843)
!913 = !DILocation(line: 43, column: 1, scope: !843)
!914 = !DILocation(line: 42, column: 3, scope: !843)
!915 = distinct !DISubprogram(name: "Test", linkageName: "_ZN4TestC2Ev", scope: !848, file: !3, line: 15, type: !852, isLocal: false, isDefinition: true, scopeLine: 15, flags: DIFlagPrototyped, isOptimized: false, unit: !2, declaration: !851, variables: !4)
!916 = !DILocalVariable(name: "this", arg: 1, scope: !915, type: !847, flags: DIFlagArtificial | DIFlagObjectPointer)
!917 = !DILocation(line: 0, scope: !915)
!918 = !DILocation(line: 15, column: 11, scope: !915)
!919 = distinct !DISubprogram(name: "~Test", linkageName: "_ZN4TestD2Ev", scope: !848, file: !3, line: 17, type: !852, isLocal: false, isDefinition: true, scopeLine: 17, flags: DIFlagPrototyped, isOptimized: false, unit: !2, declaration: !858, variables: !4)
!920 = !DILocalVariable(name: "this", arg: 1, scope: !919, type: !847, flags: DIFlagArtificial | DIFlagObjectPointer)
!921 = !DILocation(line: 0, scope: !919)
!922 = !DILocation(line: 17, column: 22, scope: !923)
!923 = distinct !DILexicalBlock(scope: !919, file: !3, line: 17, column: 11)
!924 = !DILocation(line: 17, column: 19, scope: !923)
!925 = !DILocation(line: 17, column: 25, scope: !919)
!926 = distinct !DISubprogram(name: "setX", linkageName: "_ZN4Test4setXEi", scope: !848, file: !3, line: 20, type: !856, isLocal: false, isDefinition: true, scopeLine: 20, flags: DIFlagPrototyped, isOptimized: false, unit: !2, declaration: !862, variables: !4)
!927 = !DILocalVariable(name: "this", arg: 1, scope: !926, type: !847, flags: DIFlagArtificial | DIFlagObjectPointer)
!928 = !DILocation(line: 0, scope: !926)
!929 = !DILocalVariable(name: "_x", arg: 2, scope: !926, file: !3, line: 20, type: !22)
!930 = !DILocation(line: 20, column: 17, scope: !926)
!931 = !DILocation(line: 20, column: 27, scope: !926)
!932 = !DILocation(line: 20, column: 23, scope: !926)
!933 = !DILocation(line: 20, column: 25, scope: !926)
!934 = !DILocation(line: 20, column: 31, scope: !926)
!935 = distinct !DISubprogram(name: "getX", linkageName: "_ZN4Test4getXEv", scope: !848, file: !3, line: 19, type: !860, isLocal: false, isDefinition: true, scopeLine: 19, flags: DIFlagPrototyped, isOptimized: false, unit: !2, declaration: !859, variables: !4)
!936 = !DILocalVariable(name: "this", arg: 1, scope: !935, type: !847, flags: DIFlagArtificial | DIFlagObjectPointer)
!937 = !DILocation(line: 0, scope: !935)
!938 = !DILocation(line: 19, column: 23, scope: !935)
!939 = !DILocation(line: 19, column: 16, scope: !935)
!940 = distinct !DISubprogram(name: "operator==<char, std::char_traits<char>, std::allocator<char> >", linkageName: "_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_", scope: !12, file: !941, line: 6043, type: !942, isLocal: false, isDefinition: true, scopeLine: 6045, flags: DIFlagPrototyped, isOptimized: false, unit: !2, templateParams: !946, variables: !4)
!941 = !DIFile(filename: "/usr/bin/../lib/gcc/x86_64-linux-gnu/7.4.0/../../../../include/c++/7.4.0/bits/basic_string.h", directory: "/home/shihua/klee/examples/my_example")
...
!946 = !{!947, !948, !1000}
!947 = !DITemplateTypeParameter(name: "_CharT", type: !30)
!948 = !DITemplateTypeParameter(name: "_Traits", type: !949)
!949 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "char_traits<char>", scope: !12, file: !950, line: 275, size: 8, elements: !951, templateParams: !999, identifier: "_ZTSSt11char_traitsIcE")
!950 = !DIFile(filename: "/usr/bin/../lib/gcc/x86_64-linux-gnu/7.4.0/../../../../include/c++/7.4.0/bits/char_traits.h", directory: "/home/shihua/klee/examples/my_example")
!951 = !{!952, !959, !962, !963, !967, !970, !973, !977, !978, !981, !987, !990, !993, !996}
!952 = !DISubprogram(name: "assign", linkageName: "_ZNSt11char_traitsIcE6assignERcRKc", scope: !949, file: !950, line: 284, type: !953, isLocal: false, isDefinition: false, scopeLine: 284, flags: DIFlagPrototyped | DIFlagStaticMember, isOptimized: false)
!953 = !DISubroutineType(types: !954)
!954 = !{null, !955, !957}
!955 = !DIDerivedType(tag: DW_TAG_reference_type, baseType: !956, size: 64)
!956 = !DIDerivedType(tag: DW_TAG_typedef, name: "char_type", scope: !949, file: !950, line: 277, baseType: !30)
!957 = !DIDerivedType(tag: DW_TAG_reference_type, baseType: !958, size: 64)
!958 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !956)
!959 = !DISubprogram(name: "eq", linkageName: "_ZNSt11char_traitsIcE2eqERKcS2_", scope: !949, file: !950, line: 288, type: !960, isLocal: false, isDefinition: false, scopeLine: 288, flags: DIFlagPrototyped | DIFlagStaticMember, isOptimized: false)
!960 = !DISubroutineType(types: !961)
!961 = !{!6, !957, !957}
!962 = !DISubprogram(name: "lt", linkageName: "_ZNSt11char_traitsIcE2ltERKcS2_", scope: !949, file: !950, line: 292, type: !960, isLocal: false, isDefinition: false, scopeLine: 292, flags: DIFlagPrototyped | DIFlagStaticMember, isOptimized: false)
!963 = !DISubprogram(name: "compare", linkageName: "_ZNSt11char_traitsIcE7compareEPKcS2_m", scope: !949, file: !950, line: 300, type: !964, isLocal: false, isDefinition: false, scopeLine: 300, flags: DIFlagPrototyped | DIFlagStaticMember, isOptimized: false)
!964 = !DISubroutineType(types: !965)
!965 = !{!22, !966, !966, !439}
!966 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !958, size: 64)
!967 = !DISubprogram(name: "length", linkageName: "_ZNSt11char_traitsIcE6lengthEPKc", scope: !949, file: !950, line: 314, type: !968, isLocal: false, isDefinition: false, scopeLine: 314, flags: DIFlagPrototyped | DIFlagStaticMember, isOptimized: false)
!968 = !DISubroutineType(types: !969)
!969 = !{!439, !966}
!970 = !DISubprogram(name: "find", linkageName: "_ZNSt11char_traitsIcE4findEPKcmRS1_", scope: !949, file: !950, line: 324, type: !971, isLocal: false, isDefinition: false, scopeLine: 324, flags: DIFlagPrototyped | DIFlagStaticMember, isOptimized: false)
!971 = !DISubroutineType(types: !972)
!972 = !{!966, !966, !439, !957}
!973 = !DISubprogram(name: "move", linkageName: "_ZNSt11char_traitsIcE4moveEPcPKcm", scope: !949, file: !950, line: 338, type: !974, isLocal: false, isDefinition: false, scopeLine: 338, flags: DIFlagPrototyped | DIFlagStaticMember, isOptimized: false)
!974 = !DISubroutineType(types: !975)
!975 = !{!976, !976, !966, !439}
!976 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !956, size: 64)
!977 = !DISubprogram(name: "copy", linkageName: "_ZNSt11char_traitsIcE4copyEPcPKcm", scope: !949, file: !950, line: 346, type: !974, isLocal: false, isDefinition: false, scopeLine: 346, flags: DIFlagPrototyped | DIFlagStaticMember, isOptimized: false)
!978 = !DISubprogram(name: "assign", linkageName: "_ZNSt11char_traitsIcE6assignEPcmc", scope: !949, file: !950, line: 354, type: !979, isLocal: false, isDefinition: false, scopeLine: 354, flags: DIFlagPrototyped | DIFlagStaticMember, isOptimized: false)
!979 = !DISubroutineType(types: !980)
!980 = !{!976, !976, !439, !956}
!981 = !DISubprogram(name: "to_char_type", linkageName: "_ZNSt11char_traitsIcE12to_char_typeERKi", scope: !949, file: !950, line: 362, type: !982, isLocal: false, isDefinition: false, scopeLine: 362, flags: DIFlagPrototyped | DIFlagStaticMember, isOptimized: false)
...
!986 = !DIDerivedType(tag: DW_TAG_typedef, name: "int_type", scope: !949, file: !950, line: 278, baseType: !22)
!987 = !DISubprogram(name: "to_int_type", linkageName: "_ZNSt11char_traitsIcE11to_int_typeERKc", scope: !949, file: !950, line: 368, type: !988, isLocal: false, isDefinition: false, scopeLine: 368, flags: DIFlagPrototyped | DIFlagStaticMember, isOptimized: false)
!988 = !DISubroutineType(types: !989)
!989 = !{!986, !957}
!990 = !DISubprogram(name: "eq_int_type", linkageName: "_ZNSt11char_traitsIcE11eq_int_typeERKiS2_", scope: !949, file: !950, line: 372, type: !991, isLocal: false, isDefinition: false, scopeLine: 372, flags: DIFlagPrototyped | DIFlagStaticMember, isOptimized: false)
!991 = !DISubroutineType(types: !992)
!992 = !{!6, !984, !984}
!993 = !DISubprogram(name: "eof", linkageName: "_ZNSt11char_traitsIcE3eofEv", scope: !949, file: !950, line: 376, type: !994, isLocal: false, isDefinition: false, scopeLine: 376, flags: DIFlagPrototyped | DIFlagStaticMember, isOptimized: false)
!994 = !DISubroutineType(types: !995)
!995 = !{!986}
!996 = !DISubprogram(name: "not_eof", linkageName: "_ZNSt11char_traitsIcE7not_eofERKi", scope: !949, file: !950, line: 380, type: !997, isLocal: false, isDefinition: false, scopeLine: 380, flags: DIFlagPrototyped | DIFlagStaticMember, isOptimized: false)
!997 = !DISubroutineType(types: !998)
!998 = !{!986, !984}
!999 = !{!947}
!1000 = !DITemplateTypeParameter(name: "_Alloc", type: !1001)
!1001 = !DICompositeType(tag: DW_TAG_class_type, name: "allocator<char>", scope: !12, file: !1002, line: 173, flags: DIFlagFwdDecl, identifier: "_ZTSSaIcE")
!1002 = !DIFile(filename: "/usr/bin/../lib/gcc/x86_64-linux-gnu/7.4.0/../../../../include/c++/7.4.0/bits/allocator.h", directory: "/home/shihua/klee/examples/my_example")
!1003 = !DILocalVariable(name: "__lhs", arg: 1, scope: !940, file: !941, line: 6043, type: !944)
!1004 = !DILocation(line: 6043, column: 61, scope: !940)
!1005 = !DILocalVariable(name: "__rhs", arg: 2, scope: !940, file: !941, line: 6044, type: !93)
!1006 = !DILocation(line: 6044, column: 23, scope: !940)
!1007 = !DILocation(line: 6045, column: 14, scope: !940)
!1008 = !DILocation(line: 6045, column: 28, scope: !940)
!1009 = !DILocation(line: 6045, column: 20, scope: !940)
!1010 = !DILocation(line: 6045, column: 35, scope: !940)
!1011 = !DILocation(line: 6045, column: 7, scope: !940)
